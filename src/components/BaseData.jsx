    ...
    <div className='w-[350px] flex items-center justify-center ml-6'>
      {pokeInHole
        ? <div className='flex flex-col gap-1'>
          ...
          <datalist id="move1">
            {pokeInHole.allMoves.map(elem => <option key={elem.move.name+'move1'}>{elem.move.name}</option>)}
          </datalist>
          ...
          <datalist id="move2">
            {pokeInHole.allMoves.map(elem => <option key={elem.move.name+'move2'}>{elem.move.name}</option>)}
          </datalist>
          ...
          <datalist id="move3">
            {pokeInHole.allMoves.map(elem => <option key={elem.move.name+'move3'}>{elem.move.name}</option>)}
          </datalist>
          ...
          <datalist id="move4">
            {pokeInHole.allMoves.map(elem => <option key={elem.move.name+'move4'}>{elem.move.name}</option>)}
          </datalist>
