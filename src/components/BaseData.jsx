    ...
    <div className='w-[350px] order-2 lg:order-1 flex items-center justify-center lg:justify-end lg:pr-6'>
      {pokeInHole
        ? <div className='flex flex-col gap-1'>
          ...
          <datalist id="move1">
            {pokeInHole.allMoves.map(elem => <option key={elem.move.name+'move1'+randomNum()}>{elem.move.name}</option>)}
          </datalist>
          ...
          <datalist id="move2">
            {pokeInHole.allMoves.map(elem => <option key={elem.move.name+'move2'+randomNum()}>{elem.move.name}</option>)}
          </datalist>
          ...
          <datalist id="move3">
            {pokeInHole.allMoves.map(elem => <option key={elem.move.name+'move3'+randomNum()}>{elem.move.name}</option>)}
          </datalist>
